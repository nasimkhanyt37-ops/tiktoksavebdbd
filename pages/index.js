...
export default function Home({ onShowToast }) {
  ...
  useEffect(() => {
    // Nasim: পাসওয়ার্ড সিস্টেমের স্টোরেজ কি
    const authStatus = localStorage.getItem('nasim_api_authenticated');
    if (authStatus === 'true') {
  ...
  if (!isAuthenticated) {
    return (
      <Layout title="Nasim Downloader - TikTok Video Downloader Free API">
        <PasswordModal
  ...
  return (
    <Layout 
      title="Nasim Downloader - TikTok Video Downloader Free API"
      ...
      keywords="tiktok downloader, tiktok api, video download, free api, tiktok video, social media api, nasim downloader"
    >
      {/* Header */}
      ...
      <section className="border-b-1 border-gray-900">
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto">
            ...
            <a
              href="https://www.facebook.com/share/1Bi7P1wamz/"
              target="_blank"
            ...
            >
              ...
              <p className="text-gray-600 text-sm md:text-base">Nasim Khan</p>
            </a>
            
            {/* Email Link Updated */}
            <a
              href="mailto:nasimkhanyt37@gmail.com"
              className="border-1 border-gray-900 p-4 md:p-6 text-center hover:bg-gray-50 group transition-colors"
            >
              <div className="text-gray-900 mb-3 md:mb-4">
              ...
              <p className="text-gray-600 text-sm md:text-base">nasimkhanyt37@gmail.com</p>
            </a>
            
            {/* WhatsApp/Mobile Link Updated */}
            <a
              href="https://wa.me/8801796883048"
              target="_blank"
              rel="noopener noreferrer"
              className="border-1 border-gray-900 p-4 md:p-6 text-center hover:bg-gray-50 group transition-colors"
            >
              ...
              <p className="text-gray-600 text-sm md:text-base">01796883048</p>
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-bold">NASIM DOWNLOADER</span>
            </div>
            
            <div className="flex space-x-4 md:space-x-6 mb-4 md:mb-0">
              {/* Footer Facebook Link */}
              <a href="https://www.facebook.com/share/1Bi7P1wamz/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              {/* Footer Email Link */}
              <a href="mailto:nasimkhanyt37@gmail.com" className="hover:text-gray-300 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </a>
              {/* Footer WhatsApp Link */}
              <a href="https://wa.me/8801796883048" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893 0-3.176-1.24-6.162-3.495-8.411"/>
                </svg>
              </a>
          ...
          <div className="border-t-1 border-gray-700 mt-6 pt-6 text-center">
            <p className="text-gray-300 text-sm">
              &copy; 2024 Nasim Downloader - TikTok Video Downloader Free API. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
